...
def write_into_database(comment_list,cursor,conn):
    ...
    for line in comment_list:
        try:
            cursor.execute('INSERT INTO py_product_comments_tmp(prod_asin,title,content,user_name,color,type_call,user_address,vote,prod_star,create_date,good_type,prod_website,prod_group_number)  values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',line) 
